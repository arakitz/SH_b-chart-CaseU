...
# and the one that satisfies the requirement RD = (AARL0-ARL0)/ARL0 < p' is the alpha'
for(a1 in seq(0.002,0.1,by=0.00001)){
  ...
  RD<-(AARL-370.4)/(370.4) # calculate the Relative Difference
  if(RD<pstar){break} # check if the requirement is satisfied
}
...
cat("m:",m,"adjusted FAR:",a1,'AARL:',AARL,'SDARL:',SDARL,'perc:',perc*100,'%',"RD:",RD,'\n')
